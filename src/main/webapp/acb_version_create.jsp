                                              ...
                                              <ul ng-if="person.type == 'signal'" ng-show="hiddenDiv">
                                                <li ng-repeat="i in modals" class="form-radio">
                                                      ...
                                                      <div ng-repeat="net in person.nw" class="radio radio-matrial radio-danger radio-inline">    
                                                            <label>
                                                                <input type="radio" ng-click="addnwsignal(net.id,person.id, i.vmm_id,list.slot)" name="modalmap_{{person.name}}_{{list.slot}}_{{i.vmm_id}}" ng-model="modalmap_i.vmm_id" value="" required=""/>                
