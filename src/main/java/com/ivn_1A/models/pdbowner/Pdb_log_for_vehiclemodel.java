 ...
 */
@Entity
@Table(name = "pdb_log_for_vehiclemodel")
public class Pdb_log_for_vehiclemodel implements Serializable {
    private int id;
    private Pdbversion current_pdbversion_id;
    private Pdbversion reference_pdbversion_id;
    private String removed_vehiclemodel_ids;
    ...
    @Column(name = "removed_vehiclemodel_ids", nullable = false, columnDefinition ="Text")
    public String getRemoved_vehiclemodel_ids() {
            return removed_vehiclemodel_ids;
    }

    public void setRemoved_vehiclemodel_ids(String removed_vehiclemodel_ids) {
            this.removed_vehiclemodel_ids = removed_vehiclemodel_ids;
    }
